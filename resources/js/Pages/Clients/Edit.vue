...
const props = defineProps({
  clientEquivalence: Object,
  clientes: Array,
});

const form = useForm({
  cliente_comercial: props.clientEquivalence.cliente_comercial,
  cliente_display: props.clientEquivalence.cliente_display,
});
</script>
    ...
    <div class="py-12">
      <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white p-6 overflow-hidden shadow-sm sm:rounded-lg">
          <form @submit.prevent="form.put(route('clients.update', clientEquivalence.id), { preserveScroll: true })" class="space-y-6">
            <div>
